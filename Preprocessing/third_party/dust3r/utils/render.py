...
import torch
# gsplat import deferred into render() below: gsplat is only used by the
# unused render()/get_render_results() helpers in this file (dust3r upstream
# leftover); the public symbols re-exported via dust3r/utils/__init__.py
# (render_meshes / vis_heatmap / OPENCV_TO_OPENGL_CAMERA_CONVENTION) do not
# need it. Keeping it lazy lets us drop gsplat from the install requirements.
...
def render(
    ...
    from gsplat import rasterization  # deferred (see top-of-file note)
